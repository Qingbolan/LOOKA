  ...
  'inline-flex items-center justify-center rounded-md border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none fluent-transition',
  {
    variants: {
      variant: {
        ...
        // Solid variants with white text for dark backgrounds
        'solid-success':
          'bg-green-500 text-white border-0 fluent-shadow-xs [a&]:hover:bg-green-600 [a&]:hover:fluent-shadow-sm',
        'solid-destructive':
          'bg-red-500 text-white border-0 fluent-shadow-xs [a&]:hover:bg-red-600 [a&]:hover:fluent-shadow-sm',
        'solid-primary':
          'bg-primary text-primary-foreground border-0 fluent-shadow-xs [a&]:hover:bg-primary/90 [a&]:hover:fluent-shadow-sm',
        'solid-warning':
          'bg-amber-500 text-white border-0 fluent-shadow-xs [a&]:hover:bg-amber-600 [a&]:hover:fluent-shadow-sm',
        'solid-info':
          'bg-blue-500 text-white border-0 fluent-shadow-xs [a&]:hover:bg-blue-600 [a&]:hover:fluent-shadow-sm',
      },
    },
    defaultVariants: {
      variant: 'default',
