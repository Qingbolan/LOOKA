        ...
        <div className="px-6 pt-6 pb-4">
          <div className="flex items-start justify-between">
            ...
            <div className="relative">
              ...
              <button className="absolute bottom-0 right-0 bg-primary text-white p-1 rounded-full border-2 border-white">
            ...
            <div className="flex-1 ml-6">
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-xl font-bold">时尚主理人_Ava</h2>
                <button className="text-xs px-3 py-1 border border-gray-200 rounded-full font-medium">
                  编辑资料
                </button>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="font-bold text-[16px]">12.8k</div>
                  <div className="text-[11px] text-gray-400">获赞</div>
                </div>
                <div className="text-center">
                  <div className="font-bold text-[16px]">3,420</div>
                  <div className="text-[11px] text-gray-400">粉丝</div>
                </div>
                <div className="text-center">
                  <div className="font-bold text-[16px]">286</div>
        ...
        <div className="px-4 mb-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900">身材档案</h4>
